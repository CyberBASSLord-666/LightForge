...
1. `7f1d307383ffd2c430719cde562b9bdb3b708ccb` — acoustic vocal semantic
   enrichment (including measured `releaseTime`).
2. `fe1ade7daa719e753293fede17e5642fa6815cfd` — opt-in semantic choreography.
3. This bridge commit — load order is
   `analysis/vocal-semantics.js` → `engine/semantic-choreography.js` →
   `engine/vocal-choreography.js` → `engine/show-engine.js`.
