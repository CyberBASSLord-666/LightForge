...
class VehiclePreview {
 constructor(canvas,onViewChange){
  ...
  try {this.init();this.ready=this.load();} catch(e){this.fail(e);this.ready=Promise.resolve(false);}
 }
