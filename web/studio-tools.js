...
(() => {
  ...
  function refresh() {
    ...
    $('analysisQualityNote').textContent = state.needAnalysis ? 'Music analysis has changed. Create or re-analyze to apply it; your edits are preserved.' : 'Both modes separate the voice on this device. Precision uses the full rhythm model; Balanced uses the compact rhythm model to reduce processing and memory.';
