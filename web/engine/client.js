...
(function(root){'use strict';
 ...
 root.ShowCompiler={generate:(music,settings,onProgress,signal)=>run({action:'generate',music,settings},onProgress,signal),restore:(compiled,music,settings,onProgress,signal)=>run({action:'restore',compiled,music,settings},onProgress,signal),version:'2.0.0'};
})(window);
