...
function main(){
 ...
 try{
  ...
  // Both runs use separate Node processes. Record the observation, but one pair
  // never constitutes a performance acceptance under the quality gate.
