...
test('paired gate requires matching bindings, odd multi-passage output and actual reuse',()=>{
 ...
 assert.throws(()=>validateReport({...report(true),samples:441000},{enabled:true,minPassages:2}),/odd final/);
