...
The current development source is LightForge 2.2.2, Android version code 20202. Its diagnostic logging, Downloads export and renderer-recovery update is in verification; a 2.2.2 release is not published yet. [LightForge 2.2.1](https://github.com/CyberBASSLord-666/LightForge/releases/tag/v2.2.1) remains the latest published release. Use [BUILD.md](BUILD.md) for the current model/build pipeline, [VALIDATION.md](VALIDATION.md) for evidence, and [GitHub releases](https://github.com/CyberBASSLord-666/LightForge/releases) for complete installable updates.
