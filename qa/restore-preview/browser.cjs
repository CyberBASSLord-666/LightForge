...
(async () => {
  ...
  try {
    ...
    await page.addInitScript(() => {
      ...
      window.restoreQA = {calls, job, contexts: 0};
      ...
      window.Android = {
        pickAudio() {}, getBootstrap: () => JSON.stringify({projects: [project], lastProjectId: project.id, backgroundJob: job, version: '2.2.4'}),
        getAnalysisStatus: () => JSON.stringify(job), saveProject: () => true,
