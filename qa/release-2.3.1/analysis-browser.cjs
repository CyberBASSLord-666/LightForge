...
(async()=>{
 ...
 const receipt={release:'2.3.1',passed:false,errors:[],checks:[],source_hashes:{},scope:'Actual Chromium public MusicAnalyzer with production Deux, GAME Large, Beat This and Frame-MN10. Test controls and original-stem reference scoring are independent of model inputs. No physical Android or Tesla.'};
