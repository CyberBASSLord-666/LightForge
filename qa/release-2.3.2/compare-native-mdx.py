...
OUT=ROOT/'qa/release-2.3.2'
HISTORICAL_OUT=ROOT/'qa/release-2.2.4'
WORK=Path(os.environ.get('LIGHTFORGE_MDX_COMPARISON_DIR',ROOT.parent/'native-mdx-comparison-2.3.2'))
...
def main():
    ...
    receipt={'release':'2.3.2','passed':False,'errors':[],'source_hashes':{}}
