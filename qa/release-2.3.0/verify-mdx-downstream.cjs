...
const ROOT=path.resolve(__dirname,'../..'),QA=__dirname,WORK=path.resolve(process.env.LIGHTFORGE_MDX_DOWNSTREAM_DIR||path.join(ROOT,'../native-mdx-downstream-2.3.0'));
const PAIR=path.resolve(process.env.LIGHTFORGE_MDX_DOWNSTREAM_PAIR||path.join(ROOT,'../native-mdx-comparison-2.3.0/demo-20s'));
...
async function main(){
 ...
 let receipt={release:'2.3.0',passed:false,errors:[],source_hashes:{}};
 ...
 receipt={release:'2.3.0',passed:false,errors:[],source_hashes:sources,analysis_asset_hashes:assets,
