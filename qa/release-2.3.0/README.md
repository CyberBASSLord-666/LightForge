# LightForge 2.3.0 verification source protocol

This directory contains the source helpers for a fresh 2.3.0 verification run.
...
- `qa/restore-preview/browser.cjs` when
  `LIGHTFORGE_RESTORE_QA_OUTPUT=qa/release-2.3.0`
...
historical context only. The 2.3.0 verifier never treats their source hashes or
version metadata as evidence that current 2.3.0 code ran.
...
bound to the 2.3.0 session. Do not copy prior receipts or generated outputs into
this directory.
