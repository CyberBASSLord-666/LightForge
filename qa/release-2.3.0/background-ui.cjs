...
const inputs=['qa/release-2.3.0/background-ui.cjs','version.json','web/version.js','web/app.js','web/diagnostics.js','web/diagnostics.css','web/index.html','web/styles.css','web/cockpit.css','web/cockpit.js'];
 ...
 try{
  ...
  for(const width of [320,393,768]){
   ...
   await page.addInitScript(()=>{
    ...
    window.Android={pickAudio(){},logDiagnostic:(...args)=>qaBackground.logs.push(args),exportDiagnostics(){qaBackground.exports++;},getBootstrap:()=>JSON.stringify({projects:[project],lastProjectId:project.id,version:'2.3.0',backgroundJob:qaBackground.job,deviceCapabilities:capabilities}),
