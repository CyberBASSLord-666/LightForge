...
const sources=['web/analysis/separator-deux.js','web/analysis/dsp.js','web/analysis/models/deux/manifest.json','qa/release-2.3.0/test-source-clock.cjs'];
...
(async()=>{
 ...
 const receipt={release:'2.3.0',passed:false,errors:[],source_hashes:{},scope:'Neutral masks and fake graph sessions; actual production STFT/scatter/ISTFT and overlapping chunk scheduler. No neural inference.'};
