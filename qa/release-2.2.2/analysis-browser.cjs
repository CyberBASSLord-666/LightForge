...
const sources=['qa/release-2.2.2/analysis-browser.cjs','version.json','web/analysis/ASSET_MANIFEST.json','web/analysis/worker.js','web/analysis/analyzer.js','web/analysis/game.js','web/analysis/separator-deux.js','web/analysis/stem-cache.js','web/analysis/work-store.js','web/analysis/vocal.js','web/analysis/vocal-detail.js','web/analysis/bass-notes.js','web/analysis/models/game/manifest.json','web/analysis/models/deux/manifest.json','web/engine/show-engine.js','web/engine/light-planner.js','web/engine/music-cues.js','web/engine/sync-review.js','web/engine/worker.js'];
(async()=>{
 const receipt={release:'2.2.2',passed:false,errors:[],checks:[],source_hashes:Object.fromEntries(sources.map(p=>[p,sha(path.join(root,p))])),scope:'Actual Chromium public MusicAnalyzer with production Deux, GAME Large, Beat This and Frame-MN10. Test controls and original-stem reference scoring are independent of model inputs. No physical Android or Tesla.'};
