...
tests = [ROOT / f'tests/{name}.java' for name in names]
receipt = dict(release='1.5.0', passed=False, scope='Fresh production Java compilation and host JVM tests; no Android Activity/device/document-provider or physical Tesla execution.',
