...
Version 2.2.1 / code 20201 changes Studio execution and recovery while retaining analysis v6, learned model weights, original soundtrack timing, existing musical semantics and saved-arrangement integrity. Current evidence is under `qa/release-2.2.1/`. The complete current-source Android recovery probe passes. Final production CI and signed publication are still pending; historical measurements below retain their original scope.
...
| Chromium UI and complete public analysis | **Passed against unchanged web sources.** Real UI/WebGL, responsive layouts, workers, OPFS, cancellation, persistence and export, including elapsed/passage/reuse progress. The current production verification job passes; its dependent Android job remains pending. |
| Android native Studio lifecycle | **Complete current-source probe passed.** Native Studio completion/reopen under screen-off/Doze, cancellation during a later passage, immediate Resume with verified passage reuse, resource cleanup and timeout handling. The final production Android job remains pending. |
| Signed update APK and publication | **Original-signed APK built.** Current APK: 1,171,728,522 bytes, SHA-256 `9fdbc60afecb6ce278d890f36ad58cb67623a485fd800d9e6c4215c6a7b3dd9f`. Final production CI, complete package gates and publication remain pending. |
